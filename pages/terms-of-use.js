    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <div className='mt-14 p-8 border border-black bg-red-50 border-2 border-dashed w-2/3 justify-center item-center tos'>
                <p>
                    File Crate Terms of Use
                    (Effective as of May 1, 2022)
                </p>

                <p>Welcome to the File Crate’s Terms of Use agreement. For purposes of this agreement, “Site” refers to the Company’s website, which can be accessed at https://filecrate.cc or through our mobile application. “Service” refers to the Company’s services accessed via the Site, in which users can upload files, view details of files, or download files. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service.</p>

                <p>The following Terms of Use apply when you view or use the Service via our website located at https://filecrate.cc or by accessing the Service through clicking on the application (the “App”) on your mobile device.</p>

                <p>Please review the following terms carefully. By accessing or using the Service, you signify your agreement to these Terms of Use. <b>If you do not agree to be bound by these Terms of Use in their entirety, you may not access or use the Service.</b></p>

                <p>
                PRIVACY POLICY
                The Company respects the privacy of its Service users. Please refer to the Company’s Privacy Policy (found here: https://filecrate.cc/privacy-policy) which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to the Privacy Policy as well as these Terms of Use.
                </p>

                <p>
                ABOUT THE SERVICE
                The Service allows you to upload files, download files, and view file details for simple file transfer.
                </p>

                <p>
                RULES FOR USER CONDUCT AND USE OF THE SERVICE
                You need to be at least 18 years old and a resident of the United States to use the Service.
                </p>
                ...
                <ul>
                    ...
                    <li>access another user’s file without permission;</li>
                    <li>upload any kind of illegal content;</li>
                    <li>download any kind of illegal content;</li>
                    <li>view any kind of illegal content;</li>
                    <li>provide false or inaccurate information when sharing a file;</li>
                ...
                <p>
                POSTING AND UPLOAD AND CONDUCT RESTRICTIONS
                ...
                <ul>
                    <li>You are solely responsible for your activity that occurs;</li>
                    <li>You will not post or upload any files or information that is malicious, libelous, false or inaccurate;</li>
                    <li>You will not post or upload any information that is abusive, threatening, obscene, defamatory, libelous, or racially, sexually, religiously, or otherwise objectionable and offensive;</li>
                    ...
                    <li>You will not submit content or upload anything that is copyrighted or subject to third party proprietary rights, including privacy, publicity, trade secret, or others, unless you are the owner of such rights or have the appropriate permission from their rightful owner to specifically submit such content; and</li>
                    <li>You hereby agree that we have the right to determine whether your User Content submissions or any uploads are appropriate and comply with these Terms of Service, remove any and/or all of your submissions, and terminate your account with or without prior notice.</li>
                </ul>
                ...
                (b) DMCA Take-Down Notices.  If you are a copyright owner or an agent thereof and believe, in good faith, that any materials provided on the Service infringe upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act (see 17 U.S.C 512) (“DMCA”) by sending the following information in writing to the our designated copyright agent at our web domain email address:
                ...
                <br/><br/>
                <b>YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF USE TOGETHER WITH THE PRIVACY POLICY AT https://filecrate.cc/privacy-policy REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.</b>
                </p>
            </div>
        </div>
    )
