...
function Details() {
    ...
    if (!data) return <p>File not found</p>
...
//                     <button onClick={ () => navigator.clipboard.writeText('https://filecrate.cc/details?file=' + file.secretKey) } >
...
//     let file = {}
//
//     await axios.get(`/api/file/details/${key}`, {
//         headers: {
